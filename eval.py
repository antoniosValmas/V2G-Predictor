...
ret = compute_avg_return(dqn.eval_env, dqn.agent.policy, 10)
print(f"The average return: {ret}")
...
ret = compute_avg_return(tensor_eval_env, dummy_v2g, 10)
print(f"The average return: {ret}")
...
ret = compute_avg_return(tensor_eval_env, smart_charger, 10)
print(f"The average return: {ret}")
